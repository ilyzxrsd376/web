...
const Schedule = () => {
    ...
    piketGroup = [
        ["Andre", "Azzikra", "Faiz", "Fajar", "Gathan", "Jibril", "Fazle"],
        ["Arbyan", "Dwicky", "Intan", "Meily", "Radit", "Raifandu", "Dava"],
        ["Aliffia", "Ferry", "Karin", "Lukman", "Akmal", "Naufal", "Sheren"],
        ["Abelino", "A.Faiz", "Ilyasa", "Farel", "Irfan", "Panindra", "Raka"],
        ["Yosua", "Christian", "Harlan", "Jovanda", "Daffa", "Rizki", "Halim", "Rakha"],
    ]
                ...
                <div className="text-white flex flex-col justify-center items-center mt-8 md:mt-3 overflow-y-hidden">
                    ...
                    <div data-aos="fade-up" data-aos-duration="400">
                        {TodayComponent ? (
                            ...
                            <p className="opacity-50">Libur Kocak -Admin</p>
                        )}
                    </div>
                </div>
            </div>
